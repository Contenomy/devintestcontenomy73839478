...
import {Box,Button,TextField,Typography,Select,FormControl,InputLabel,MenuItem,Checkbox,FormControlLabel, Link} from "@mui/material";
...
const CheckRegPage: React.FC = () => {
  ...
  function handleRegSelChange(event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) {
    const { name, value } = event.target;
